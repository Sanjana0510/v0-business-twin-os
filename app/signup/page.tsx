...
export default function SignupPage() {
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#0f172a]">
      {/* LEFT SIDE - Hero Image (50% width, full height) */}
      <div className="hidden lg:block lg:w-1/2 h-screen relative overflow-hidden">
        {/* Hero Image */}
        <Image
          src="/auth-hero.png"
          alt="Create Your Vision - AI Platform"
          fill
        ...
        {/* Inspiration Text - Bottom Left */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.5 }}
          className="absolute bottom-12 left-8 z-20 max-w-sm"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">
            Create Your Vision
          </h2>
          <p className="text-slate-300 text-sm md:text-base">
            An AI-assisted workspace to craft and elevate your business intelligence
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600 text-sm">
              Join thousands of companies using Business Twin OS to drive AI-powered decisions
            </p>
          </div>
